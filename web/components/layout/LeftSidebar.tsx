			...
			<Tabs defaultValue="explorer" className="flex flex-col h-full">
				...
				>
					...
					<div className="px-4 py-2">
						<div className="flex items-center space-x-2 py-1 hover:bg-accent/50 rounded">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="16"
								height="16"
						...
						<div className="flex items-center space-x-2 py-1 hover:bg-accent/50 rounded pl-4">
							<svg
								xmlns="http://www.w3.org/2000/svg"
								width="16"
								height="16"
