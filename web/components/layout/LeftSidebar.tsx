  ...
  return (
    <div className="flex flex-col h-full bg-[#252526] border-r border-[#1e1e1e]">
      <Tabs defaultValue="explorer" className="flex flex-col h-full">
        ...
        <TabsContent value="explorer" className="flex-1 overflow-y-auto p-0 m-0">
          <div className="p-3 text-sm font-medium">EXPLORER</div>
          <div className="px-4 py-2">
            <div className="flex items-center space-x-2 py-1 hover:bg-[#37373d] rounded">
            ...
            <div className="flex items-center space-x-2 py-1 hover:bg-[#37373d] rounded pl-4">
              <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-folder">
                <path d="M4 20h16a2 2 0 0 0 2-2V8a2 2 0 0 0-2-2h-7.93a2 2 0 0 1-1.66-.9l-.82-1.2A2 2 0 0 0 7.93 3H4a2 2 0 0 0-2 2v13c0 1.1.9 2 2 2Z"/>
              </svg>
              <span>app</span>
        ...
        <TabsContent value="search" className="flex-1 overflow-y-auto p-0 m-0">
          ...
          <div className="px-4 py-2">
            <input 
              ...
              className="w-full bg-[#3c3c3c] text-sm text-[#cccccc] border border-[#3c3c3c] rounded px-2 py-1"
            />
          </div>
        </TabsContent>
        ...
        <TabsContent value="git" className="flex-1 overflow-y-auto p-0 m-0">
          ...
          <div className="px-4 py-2">
            <div className="text-sm text-[#cccccc]">No changes detected</div>
          </div>
        </TabsContent>
        
        <TabsContent value="extensions" className="flex-1 overflow-y-auto p-0 m-0">
